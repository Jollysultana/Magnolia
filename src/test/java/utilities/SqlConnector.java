...
public class SqlConnector {
    ...
    private static final String User = ReadConfigFiles.gePropertyValues("DbUser");
    private static final String Password = ReadConfigFiles.gePropertyValues("DbPassword");
